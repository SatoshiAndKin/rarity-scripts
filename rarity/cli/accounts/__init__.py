...
def from_mnemonic(name, mnemonic, mnemonic_passphrase, encryption_passphrase, offset, save_pass):
    """Create a brownie account from an existing mnemonic."""
    from .mnemonic import account_from_mnemonic

    account_from_mnemonic(mnemonic, mnemonic_passphrase, offset, name, encryption_passphrase, save_pass=save_pass)
